@extends('master')
@section('title','Skill question registration')
@section('menu')
@parent
@endsection
@section('content')
                ...
                <form method="post">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <textarea  id="question_content" class="form-control {{ ($errors->first('content')) ? 'is-invalid'  :'' }}"  name="content" rows=4>{{ old('content') }}</textarea>
